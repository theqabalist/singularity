module.exports = (function (adt, _) {
    ...
    return adt.data("Reader", {_Reader: 1})
        ...
        .static("lift", adt.monad.lift("Reader"))
        .implements("run", {
            _Reader: function (r, e) {
                return r(e);
            }
        })
        .implements("map", {_Reader: adt.monad.map("_Reader", "Reader")})
        .implements("ap", {_Reader: adt.monad.ap("_Reader", "Reader")})
        .implements("mbind", {
        ...
        .implements("ask", {
            _Reader: function (r, g, t) {
                return t._Reader.from(r).mbind(function (t1) {
                    return t.Reader.ask().mbind(function (e) {
                        return g(e, t1);
                    });
                });
            }
        ...
        .implements("asks", {
            _Reader: function (r, f, g, t) {
                return t._Reader.from(r).mbind(function (t1) {
                    return t.Reader.asks(f).mbind(function (e) {
                        return g(e, t1);
                    });
                });
            }
        ...
        .implements("local", {
            _Reader: function (r, f, g, t) {
                return t._Reader.from(r).mbind(function (t1) {
                    return t.Reader.local(f).mbind(function (e) {
                        return g(e, t1);
                    });
                });
            }
