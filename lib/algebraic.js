...
module.exports = (function (_) {
    ...
    return {
        data: data,
        monad: {
            lift: _.curry(function (type, f, t) { return t[type].mreturn(_.curry(f)); }),
            map: function (rebuild, ret) {
                return function () {
                    ...
                    return t[rebuild].from.apply(null, cargs).mbind(function (t1) {
                        return t[ret].mreturn(f(t1));
                    });
                };
            },
            ap: function (rebuild, ret) {
                return function () {
                    var args = _.toList(arguments),
                        ...
                        cargs = _.initial(_.initial(args));
                    return t[rebuild].from.apply(null, cargs).mbind(function (f) {
