    ...
    return adt.data("Writer", {_Writer: 2})
        ...
        .implements("map", {
            _Writer: function (log, v, f, t) {
                return t._Writer.from(log, f(v));
            }
        })
        .implements("ap", {
            _Writer: function (log, f, m, t) {
                var other = m.val(selectFirst),
                    v = m.val(selectSecond);
                return t._Writer.from(log.mappend(other), f(v));
            }
        })
        .implements("flatMap", {
            _Writer: function (log, v, f, t) {
